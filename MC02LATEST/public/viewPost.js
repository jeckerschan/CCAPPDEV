...
function displaySpecificPost(posts, postId) {
...
$(document).ready(function () {
    // Extract the postId from the URL or any other source
    var postId = 'your_post_id_here'; // Replace 'your_post_id_here' with the actual postId
    fetchPosts()
        .then(posts => displaySpecificPost(posts, postId))
        .catch(error => {
            console.error('Error:', error);
            alert('Failed to fetch and display the post.');
        });
});